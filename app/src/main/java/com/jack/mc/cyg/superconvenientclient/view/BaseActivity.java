...
import com.jack.mc.cyg.superconvenientclient.cyg.util.CygSharedPreferences;
...
public class BaseActivity extends Activity {
    ...
    public static boolean isLogin() {
        return !CygStringUtil.isEmpty(CygSharedPreferences.getString(MyCode.USER, MyCode.USER_TOKEN, ""));
    }
